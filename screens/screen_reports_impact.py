...
def build(page: ft.Page, **kwargs) -> ft.Control:
    ...
    mensaje_bloqueo = (
        ...
        else "Sin acceso a reportes de impacto."
    )
    ...
    def _build_report_list():
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Text(mensaje_bloqueo if sin_contexto_operativo else "No hay reportes de impacto registrados", size=16, color=COLOR_TEXTO_SEC),
                        ],
        ...
        for r in reportes:
            ...
            # ── Chips de planificación de la actividad vinculada ──
            chips_planificacion = []
