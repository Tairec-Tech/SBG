...
from database.crud_usuario import (
    registrar_institucion_completa,
    email_ya_existe,
    usuario_ya_existe,
    ...
    async def on_registrar(e):
        ...
        try:
            ...
            try:
                ...
                # Transacción atómica: institución + directivo + 11 brigadas
                id_inst, _id_usuario = registrar_institucion_completa(
                    nombre_inst=nom_inst.value.strip(),
                    ...
                    email_admin=(correo.value or "").strip().lower(),
                    contrasena_plana=contrasena.value,
                    usuario_admin=usuario_str.lower(),
                    cedula_admin=(cedula_admin.value or "").strip() or None,
                )
                # Guardar logo — error no fatal (registro ya fue exitoso)
                ...
                if ruta_logo and os.path.isfile(ruta_logo):
                    try:
                        ...
                        pass  # Logo es error no fatal; el registro principal ya fue exitoso
                page.snack_bar = ft.SnackBar(ft.Text("¡Registro exitoso! Se crearon la institución, el directivo y las 11 brigadas base. Ahora inicie sesión."), bgcolor="#22c55e")
