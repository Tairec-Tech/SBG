...
from database.crud_usuario import listar_brigadistas_visibles_only, es_profesor, es_admin
...
def _build_filtros_y_lista(page, refresh_callback=None):
    ...
    fila_filtros = ft.Row(
        [
            ...
            ft.OutlinedButton(
                content=ft.Row(
                    [
                        ft.Icon(ft.Icons.CLEAR_ALL_ROUNDED, size=18, color=COLOR_PRIMARIO),
                        ft.Text("Limpiar filtros", size=13, weight=ft.FontWeight.W_600, color=COLOR_PRIMARIO),
                    ],
                    spacing=6,
                ...
                style=ft.ButtonStyle(
                    ...
                    overlay_color=ft.Colors.with_opacity(0.12, COLOR_PRIMARIO),
                ),
            ),
        ],
        wrap=True,
    ...
    card_filtros = ft.Container(
        ...
        padding=ft.Padding(24, 24, 24, 28),
        border_radius=RADIO,
        bgcolor=COLOR_CARD,
