...
def listar_turnos(brigada_id: int | None = None, tipo_brigada=None, brigada_rol_id=None, institucion_id=None):
    """Lista turnos, opcionalmente filtrados por institucion_id, brigada_id, tipo_brigada o brigada_rol_id."""
    _asegurar_tabla_turno()
    conditions = []
    params = []
    ...
    if brigada_rol_id is not None:
        ...
        conditions.append("b.Institucion_Educativa_idInstitucion = %s")
    ...
    if tipo_brigada and brigada_rol_id is None and institucion_id is None:
        conditions.append("b.tipo_brigada = %s")
        params.append(tipo_brigada)
    where = ""
    if conditions:
...
def get_turno_stats(tipo_brigada=None, brigada_rol_id=None, institucion_id=None):
    ...
    if brigada_rol_id is not None:
        ...
        if tipo_brigada:
            ...
            params = [institucion_id, tipo_brigada]
        else:
