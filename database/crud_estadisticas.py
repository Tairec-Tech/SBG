...
def _fetch_descripciones_actividades(tipo_brigada=None, brigada_rol_id=None):
...
def get_actividades_por_momento(tipo_brigada=None, brigada_rol_id=None):
    """Agrupa actividades por momento_escolar (parseado desde JSON en Python)."""
    descripciones = _fetch_descripciones_actividades(tipo_brigada, brigada_rol_id)
    if not descripciones:
        return []
    return _agrupar_por_campo_json(descripciones, "momento_escolar", "Sin momento")


def get_actividades_por_origen(tipo_brigada=None, brigada_rol_id=None):
...
def get_actividades_por_nivel(tipo_brigada=None, brigada_rol_id=None):
