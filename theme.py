...
TEMA_ECO_OSCURO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        outline="#374151",
        on_tertiary_container="#6ee7b7",
        scrim="#9ca3af",
        shadow="black",
        error="#f87171",
        on_error="#1c1917",
        tertiary_container="#065f46",
...
# =====================================================================
# PALETA GESTIÓN DE RIESGO (Naranja)
# =====================================================================
HEX_RIESGO_PRIMARIO = "#ea580c"
HEX_RIESGO_PRIMARIO_CLARO = "#f97316"
HEX_RIESGO_PRIMARIO_OSCURO = "#c2410c"
HEX_RIESGO_SUAVE = "#fed7aa"
HEX_RIESGO_FONDO = "#fff7ed"
HEX_RIESGO_SIDEBAR = "#431407"
...
TEMA_RIESGO_CLARO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        surface_container="#f8fafc",
        outline="#e2e8f0",
        on_tertiary_container="#fdba74",
        scrim="#64748b",
        shadow="black",
        error="#ef4444",
        on_error="white",
        tertiary_container="#7c2d12",
...
TEMA_RIESGO_OSCURO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        outline="#374151",
        on_tertiary_container="#fb923c",
        scrim="#9ca3af",
        shadow="black",
        error="#f87171",
        on_error="#1c1917",
        tertiary_container="#9a3412",
...
# =====================================================================
# PALETA PATRULLA ESCOLAR (Rojo)
# =====================================================================
HEX_PATRULLA_PRIMARIO = "#dc2626"
HEX_PATRULLA_PRIMARIO_CLARO = "#ef4444"
HEX_PATRULLA_PRIMARIO_OSCURO = "#991b1b"
HEX_PATRULLA_SUAVE = "#fecaca"
HEX_PATRULLA_FONDO = "#fef2f2"
HEX_PATRULLA_SIDEBAR = "#450a0a"
...
TEMA_PATRULLA_CLARO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        surface_container="#f8fafc",
        outline="#e2e8f0",
        on_tertiary_container="#fca5a5",
        scrim="#64748b",
        shadow="black",
        error="#ef4444",
        on_error="white",
        tertiary_container="#7f1d1d",
...
TEMA_PATRULLA_OSCURO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        outline="#374151",
        on_tertiary_container="#f87171",
        scrim="#9ca3af",
        shadow="black",
        error="#f87171",
        on_error="#1c1917",
        tertiary_container="#991b1b",
...
TEMA_CONVIVENCIA_CLARO = ft.Theme(
    color_scheme=ft.ColorScheme(
        ...
        surface_container="#f8fafc",
        outline="#e2e8f0",
        on_tertiary_container="#94a3b8",
        scrim="#64748b",
        shadow="black",
        error="#ef4444",
        on_error="white",
        tertiary_container="#334155",
...
BRIGADAS = {
    ...
    "auxilios": {
        ...
        "hex_primario": "#eab308",
        "hex_primario_claro": "#facc15",
        "hex_primario_oscuro": "#ca8a04",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#fefce8",
    ...
    "educacion_fisica": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#3b82f6",
        "hex_primario_claro": "#60a5fa",
        "hex_primario_oscuro": "#2563eb",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#eff6ff",
    ...
    "conuco": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#84cc16",
        "hex_primario_claro": "#a3e635",
        "hex_primario_oscuro": "#65a30d",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#f7fee7",
        "icono": "AGRICULTURE",
    },
    "patrimonio": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#ec4899",
        "hex_primario_claro": "#f472b6",
        "hex_primario_oscuro": "#db2777",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#fdf2f8",
        "icono": "MUSEUM",
    },
    "artes": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#a855f7",
        "hex_primario_claro": "#c084fc",
        "hex_primario_oscuro": "#9333ea",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#faf5ff",
        "icono": "PALETTE",
    },
    "patriotica": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#9ca3af",
        "hex_primario_claro": "#d1d5db",
        "hex_primario_oscuro": "#6b7280",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#f9fafb",
        "icono": "FLAG",
    },
    "ddhh": {
        ...
        "oscuro": TEMA_NEUTRA_OSCURO,
        "hex_primario": "#1e3a8a",
        "hex_primario_claro": "#1d4ed8",
        "hex_primario_oscuro": "#1e3a8b",
        "hex_sidebar": HEX_NEUTRA_SIDEBAR,
        "hex_fondo": "#eff6ff",
        "icono": "GAVEL",
    },
...
# Sidebar
COLOR_SIDEBAR = ft.Colors.TERTIARY
COLOR_SIDEBAR_ACTIVO = ft.Colors.TERTIARY_CONTAINER
COLOR_SIDEBAR_TEXTO = ft.Colors.ON_TERTIARY
COLOR_SIDEBAR_TEXTO_SEC = ft.Colors.ON_TERTIARY_CONTAINER
